...
const Footer: React.FC = () => {
	return (
		<footer className="mt-16 border-t border-border bg-foreground/2">
			<div className="container py-10">
				<div className="flex flex-col md:flex-row gap-8 md:gap-4 justify-between">
					<div className="space-y-2">
						<h3 className="text-lg font-semibold">Gilles Donn</h3>
					...
					<div>
						...
						<ul className="mt-3 flex items-center gap-4">
							<li>
								<a className="hover:text-primary transition-colors" href="https://www.linkedin.com/in/kodjo-gilles" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
									<FaLinkedin size={20} />
								</a>
							</li>
							<li>
								<a className="hover:text-primary transition-colors" href="https://github.com/w4lk17" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
									<FaGithub size={20} />
								</a>
							</li>
							<li>
								<a className="hover:text-primary transition-colors" href="mailto:gnamavogilles@gmail.com" aria-label="Email">
									<FaEnvelope size={20} />
								</a>
							</li>
						</ul>
				...
				<div className="mt-8 border-t border-border pt-4 text-center text-xs text-muted-foreground">
					<p>&copy; {new Date().getFullYear()} Gilles Donn. All rights reserved.</p>
				</div>
			</div>
		</footer>
	);
