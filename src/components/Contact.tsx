...
const ContactSection: React.FC = () => {
	...
	const handleSubmit = async (e: React.FormEvent) => {
		...
		try {
			const response = await fetch('https://formsubmit.co/gnamavogilles@gmail.com', {
				method: 'POST',
				headers: {
	...
	return (
		<section id="contact" className="py-16 sm:py-20 lg:py-24 bg-foreground/2">
					...
					<div className="flex-1 min-w-[280px]">
						...
						<div className="mt-6 space-y-4">
							<div className="flex items-center gap-3">
								...
								<a href="mailto:gnamavogilles@gmail.com" className="hover:text-primary transition-colors">
									gnamavogilles@gmail.com
								</a>
							</div>
							<div className="flex items-center gap-3">
								<FaLinkedin className="text-primary" />
								<a href="https://www.linkedin.com/in/kodjo-gilles" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">
									linkedin.com/in/kodjo-gilles
								</a>
							</div>
							<div className="flex items-center gap-3">
								<FaGithub className="text-primary" />
								<a href="https://github.com/w4lk17" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">
									github.com/w4lk17
								</a>
							</div>
						</div>
